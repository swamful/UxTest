...
@implementation ArrowMoveController
...
- (void)viewDidLoad
{
    ...
    ArrowMoveView *arrowView = [[ArrowMoveView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height)];
