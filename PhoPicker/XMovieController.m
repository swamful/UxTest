...
#import "XMovieView.h"
@implementation XMovieController
...
- (void)viewDidLoad
{
    ...
    XMovieView *xmovieView = [[XMovieView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height)];
    [self.view addSubview:xmovieView];
    [xmovieView release];
